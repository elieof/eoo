...
object Eoo {
    ...
    const val awsJavaVersion = "1.11.888"
    ...
    const val cucumberJvmVersion = "6.8.1"
    const val commonsIoVersion = "2.8.0"
    const val dropwizardMetricsVersion = "4.1.14"
    ...
    const val hazelcastVersion = "4.0.3"
    const val hazelcastHibernate53Version = "2.1.1"
    const val hibernateVersion = "5.4.21.Final"
    ...
    const val mongockVersion = "4.1.17"
    ...
    const val redissonVersion = "3.13.6"
